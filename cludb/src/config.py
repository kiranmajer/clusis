...
# m* from papers about experimental band structures
        ...
        # select tupels in the compare plot to define the limits between isomers
        self.water_isomer_limits = {'H2O': {'2': [[0.36, 0.89], [0.27, 1.19]],
                                            '1a': [[0.356, 1.398], [0.269, 1.687], [0.2155, 2.2],
                                                      [0.1, 2.66]],
                                            '1b': [[0.31, 1.96], [0.269, 2.03], [0.25, 2.21],
                                                   [0.11, 3.25]]
                                            },
                                    'D2O': {'2': [[0.366, 0.85], [0.27, 1.19]],
                                            '1a': [[0.38, 1.2], [0.27, 1.73]],
                                            '1b': [[0.28, 2.02], [0.264, 2.058], [0.25, 2.16]]
                                            }
                                    }
        
        self.water_isomer_color_map = {'2': 'indigo',
                                       '1a': 'limegreen',
                                       '1b': 'blue',
                                       'vib': 'red',
                                       }
