...
#                         self.data.append(float(line.strip()))
            ...
            self.data = y # last point has sometimes a strange value like 32768. Skip it!
            self.metadata['triggerOffset'] = -1*x[0]
            self.metadata['timePerPoint'] = x[1] - x[0]
            self.metadata['referenceTime'] = 0
            self.metadata['referenceTimeImport'] = 0
            self.metadata['timeOffset'] = 0
            self.metadata['timeOffset'] = 0
            self.metadata['timeOffsetImport'] = 0
    ...
    def get_recTime(self, spectype):
        ...
        '''
        self.metadata['recTime'] = os.stat(self.metadata['datFileOrig']).st_mtime
